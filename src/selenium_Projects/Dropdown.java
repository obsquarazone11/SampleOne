...
public class Dropdown {
	...
	public static void main(String[] args) {
		...
		WebElement first_element = s.getFirstSelectedOption();
		String first_element_value = first_element.getText();
		System.out.println(first_element_value);
		s.selectByValue("Red");
		WebElement first_element2 = s.getFirstSelectedOption();
		String first_element_value2 = first_element2.getText();
		System.out.println(first_element_value2);
		s.selectByIndex(2);
		WebElement first_element3 = s.getFirstSelectedOption();
		String first_element3_value = first_element3.getText();
		System.out.println(first_element3_value);
		s.selectByVisibleText("Green");
		WebElement first_element4 = s.getFirstSelectedOption();
		String first_element_value4 = first_element4.getText();
